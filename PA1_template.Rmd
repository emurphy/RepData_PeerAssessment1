...
The histogram abond summary ave shows hat the shape of the distribution is s similar, with no change to the mean and median. Imputing missing data has not significantly changed the estimates of total daily number of steps. 
